...
exports.seedLeiSeca = void 0;
const https_1 = require("firebase-functions/v2/https");
const shared_1 = require("./shared");
const firestore_1 = require("firebase-admin/firestore");
// ─── Função temporária para seed de Lei Seca — REMOVER APÓS USO ───────────
exports.seedLeiSeca = (0, https_1.onRequest)({ region: 'us-central1', invoker: 'private' }, async (req, res) => {
    const now = Date.now();
    ...
    for (const ev of events) {
        const ref = await shared_1.db.collection('events').add({
...
//# sourceMappingURL=seedLeiSeca.js.map